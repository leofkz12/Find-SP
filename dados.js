...
const hqs = {
  ...
  "frieren": {
    ...
    resumo: "A sinopse acompanha a maga elfa Frieren, que, após uma década de jornada para derrotar o Rei Demônio junto ao herói humano Himmel, retorna à vida comum.  Devido à sua longa vida élfica, Frieren não compreende a efemeridade da vida humana e testemunha seus companheiros envelhecerem e morrerem. Anos após a morte de Himmel, ela embarca em uma nova jornada com sua aprendiz humana, Fern, e posteriormente com o guerreiro Stark.",
    capitulos: {
      "cap-1": 1
    }
  },
  "miles-morales": {
    ...
    resumo: "A sinopse da história foca no Miles Morales enfrentando o Escorpião (Mac Gargan), que possui o simbionte Venom.  Quando uma horda de acólitos do Carnificina ataca Nova York, Miles é infectado pelo simbionte vermelho e possuído, transformando-se temporariamente em um vilão. ",
    capitulos: {
      "cap-1": 21,
      "cap-2": 1
    }
